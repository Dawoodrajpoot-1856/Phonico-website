    ...
    <div>
      <div className="mt-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full max-w-[1400px] mx-auto mt-10 sm:mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:hidden bg-[#faf5f0]/50 p-6 rounded-2xl border border-orange-50">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="font-medium mt-1 text-sm text-slate-400 leading-relaxed">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="font-medium mt-1 text-sm text-slate-200 leading-relaxed">
          ...
          {/* DESKTOP LAYOUT */}
          <div className="hidden lg:block relative mx-auto w-[1270px] min-h-[600px] lg:min-h-[650px]">
            <img
              src="/stepsBg.svg"
            ...
            {/* Step 1 */}
            <div className="absolute z-10 top-[75%] left-[8%] max-w-[500px]">
              <h2 className="font-bold text-2xl text-slate-950">
                Choose Your Plan
              </h2>
              <p className="font-semibold mt-2 text-xl text-slate-400 leading-relaxed">
                Select the best eSIM plan that meets your needs.
              </p>
            </div>
