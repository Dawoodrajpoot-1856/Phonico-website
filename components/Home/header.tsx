    ...
    <>
      <div className="bg-white sticky top-0 z-50">
        ...
        <div className="flex flex-row justify-between items-center h-20 px-4 2xl:max-w-7xl mx-auto w-full">
          ...
          {/* DESKTOP MENU - Switched md: to lg: for perfect Tab handling */}
          ...
          {/* DESKTOP ACTIONS - Switched md: to lg: */}
          ...
          {/* MOBILE & TAB TOGGLE BUTTON - Works smoothly on md: screens now */}
        ...
        {/* MOBILE & TAB DROPDOWN LINKS */}
        {isOpen && (
          <div className="lg:hidden bg-white border-t border-gray-100 px-4 py-4 shadow-lg absolute left-0 right-0 top-20 flex flex-col gap-4 animate-in fade-in slide-in-from-top-5 duration-200">
      ...
      {/* CART DRAWER */}
      <div
        className={`fixed top-0 bottom-5 rounded-2xl mt-20 right-0 h-[calc(100vh-100px)] w-[88%] sm:w-[400px] bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="p-4 space-y-4 overflow-y-auto h-[calc(100vh-270px)] sm:h-[calc(100vh-190px)]">
          {!isMounted || cart.length === 0 ? (
            ...
            cart.map((item, index) => (
              <div
                key={item.id || index}
                className="p-3 flex gap-3 items-center bg-gray-50/50 rounded-lg"
              >
                <img
                  src="https://phonico.com/_next/image/?url=%2Fimages%2FsiteLogo.png&w=256&q=75"
                  className="w-20 h-16 object-contain bg-white rounded p-1 shrink-0"
                  alt="Logo"
                />
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <button
                    ...
                    className="p-1 rounded-lg text-[#ec3c65] transition-colors cursor-pointer"
                    title="Delete item"
                  >
                    <svg
        ...
        <div className="p-4 absolute bottom-0 left-0 right-0 bg-white shadow-[0_-4px_12px_rgba(0,0,0,0.03)] rounded-b-2xl">
